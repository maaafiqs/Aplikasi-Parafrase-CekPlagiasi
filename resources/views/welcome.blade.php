...
<head>
    ...
    <title>PenaHitung — Cek Kata, Paragraf & Dokumen Word</title>
    ...
    <!-- Mammoth.js for client-side Word (.docx) parsing -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/mammoth/1.8.0/mammoth.browser.min.js"></script>
    
    <!-- SweetAlert2 for premium popup alerts -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    
    <!-- JSZip for unzipping docx files -->
...
<body class="bg-slate-50 dark:bg-zinc-950 text-slate-800 dark:text-zinc-100 min-h-screen transition-colors duration-300 relative overflow-x-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 flex flex-col min-h-screen justify-between">
        ...
        <!-- Header Section -->
        <header class="flex justify-between items-center mb-8 border-b border-slate-200/60 dark:border-zinc-800/60 pb-6">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-500 to-emerald-500 flex items-center justify-center shadow-lg shadow-indigo-500/20">
                    <i data-lucide="sparkles" class="w-5 h-5 text-white"></i>
                </div>
                <div>
                    <h1 class="text-xl font-bold tracking-tight text-slate-900 dark:text-white flex items-center gap-2">
                        PenaHitung
                        <span class="text-[10px] font-semibold bg-emerald-100 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-400 px-2 py-0.5 rounded-full uppercase tracking-wider">v1.0</span>
                    </h1>
                    <p class="text-xs text-slate-500 dark:text-zinc-400">Analisis kata, dokumen Word, & teks secara instan</p>
                </div>
            </div>
        ...
        <!-- Main Body -->
        <main class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-auto">
        ...
        <footer class="mt-12 pt-6 border-t border-slate-200/60 dark:border-zinc-800/60 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400 dark:text-zinc-500">
            <p>© 2026 PenaHitung. Dirancang dengan keindahan & kinerja.</p>
            <div class="flex gap-4">
                <span>Didukung oleh Mammoth.js</span>
                <span>•</span>
                <span>Analisis Sisi Klien Instan</span>
            </div>
        </footer>
